...
| [**nasa-apod-demo**](nasa-apod-demo/nasa-apod-guide.md) | NASA Astronomy Picture of the Day — stunning space imagery as a visual hook. Free API, no credentials, pairs with Planet for a "space to Earth" narrative. |
